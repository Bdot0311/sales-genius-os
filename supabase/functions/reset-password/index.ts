            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #0a0a0a;">
              <tr>
                <td align="center" style="padding: 40px 20px;">
                  <table role="presentation" width="500" cellpadding="0" cellspacing="0" style="max-width: 500px; background-color: #141414; border-radius: 12px; border: 1px solid #333333;">
                    <!-- Header -->
                    <tr>
                    ...
                    <!-- Footer -->
                    <tr>
                      <td align="center" style="background-color: #0a0a0a; padding: 20px 30px; border-top: 1px solid #333333; border-radius: 0 0 12px 12px;">
