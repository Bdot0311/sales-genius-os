...
const PricingPage = () => {
  const pricingFAQs = [
    ...
    { question: "Do you offer yearly billing?", answer: "Yes! Save ~20% with annual billing. Your full annual credit pool is granted upfront: Starter gets 12,000, Growth gets 14,400, and Pro gets 36,000 prospects." },
