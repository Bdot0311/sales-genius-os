...
const ApiDocs = () => {
  ...
  const handleDownloadDocs = () => {
    const lines: string[] = ["OUTREIGN API DOCUMENTATION", "=".repeat(50), `Base URL: ${BASE_URL_TEMPLATE}`, `Generated: ${new Date().toISOString()}`, ""];
    ...
    a.href = url; a.download = "outreign-api-docs.txt"; a.click();
