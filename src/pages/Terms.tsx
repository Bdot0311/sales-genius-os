...
const Terms = () => {
  useEffect(() => {
    document.title = "Terms of Service - SalesOS";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "SalesOS Terms of Service - Review our terms and conditions for using our AI-powered sales platform.");
    }
  }, []);
