...
const SEQUENCE_TEMPLATES = [
  {
    ...
    steps: [
      ...
      { delay_days: 8, delay_hours: 0, subject_template: "Thought you'd find this useful", body_template: "Hi {{contact_name}},\n\nNo pitch today — just sharing an insight we published on how fast-growing teams are rethinking outbound.\n\n[Link to resource]\n\nHope it's useful.", trigger_condition: "on_delay" },
  ...
  },
  {
    ...
    icon: Crown,
    steps: [
      { delay_days: 0, delay_hours: 0, subject_template: "{{contact_name}} — quick question", body_template: "Hi {{contact_name}},\n\n{{company_name}} is scaling fast, and I imagine {{pain_point}} is on your radar.\n\nWe help leaders like you solve that. Worth 15 minutes?", trigger_condition: "on_enroll" },
      { delay_days: 3, delay_hours: 0, subject_template: "Re: {{contact_name}} — quick question", body_template: "Hi {{contact_name}},\n\nBumping this up — wanted to make sure it didn't get buried.\n\nHappy to share how we helped a similar company cut their outreach time by 3x. Just say the word.", trigger_condition: "on_delay" },
      { delay_days: 7, delay_hours: 0, subject_template: "Re: {{contact_name}} — quick question", body_template: "Hi {{contact_name}},\n\nI'll assume the timing isn't right — totally understand.\n\nIf things shift, I'd love to reconnect. Wishing you and {{company_name}} a strong quarter.", trigger_condition: "on_delay" },
    ],
  },
  {
    id: "the-challenger",
